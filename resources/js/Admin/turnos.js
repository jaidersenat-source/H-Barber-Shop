    ...
    modal.innerHTML = `
        <div style="background:#fff;padding:2.5rem 2rem;border-radius:16px;max-width:420px;width:95vw;box-shadow:0 4px 24px rgba(0,0,0,0.18);position:relative;">
            ...
            <form id="form-turno-modal">
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    <label for="tur_correo">Correo electrónico</label>
                    <input type="email" id="tur_correo" name="tur_correo" class="form-control" required placeholder="cliente@correo.com">
                </div>
                <div class="form-group" style="margin-bottom:1rem;">
                ...
                <input type="hidden" name="servicio_id" value="${datos.servicioId || ''}">
