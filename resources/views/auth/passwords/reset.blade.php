...
<div class="reset-container" aria-label="Restablecimiento de contraseña">
    <!-- Sección de branding -->
    ...
    <main class="form-section" role="main" aria-label="Formulario de restablecimiento de contraseña">
        <div class="reset-box">
            <div class="reset-header">
                <h2 id="tituloReset">Restablecer contraseña</h2>
            ...
            <form method="POST" action="{{ route('password.update') }}" id="resetForm" aria-labelledby="tituloReset" aria-label="Formulario para restablecer contraseña">
                @csrf
                ...
                <div class="form-group">
                    <label for="password-confirm">Confirmar contraseña <span aria-hidden="true">*</span></label>
                    <input 
                        id="password-confirm" 
                        type="password" 
                ...
                <button type="submit" class="btn-primary" aria-label="Restablecer contraseña">
