...
<main class="configuracion-container" role="main" aria-labelledby="page-title" id="modulo-configuracion-perfil">
    ...
    <section class="form-section foto-perfil-section" aria-labelledby="foto-titulo">
        ...
        <form
            method="POST"
            action="{{ route('barbero.perfil.guardarFoto') }}"
    ...
    <form 
        method="POST" 
        action="{{ route('barbero.perfil.update') }}" 
    ...
    >
        ...
        <div class="form-actions" style="margin-top:1rem;">
            ...
            <a href="{{ route('barbero.perfil.show') }}" class="btn btn-secondary" style="margin-left:.5rem;">Cancelar</a>
        </div>
