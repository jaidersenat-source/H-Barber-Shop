...
<div class="card" role="region" aria-labelledby="form-title" id="modulo-personal">
   ...
   @vite(['resources/css/Admin/personal/pcreate.css'])
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <select id="rolSelect"
                        ...
                        class="@error('rol') input-error @enderror">
                ...
                <span id="rol-hint" class="hint">El rol de Administrador requiere confirmación con contraseña</span>
                @error('rol')
                    <span class="error-message" role="alert">{{ $message }}</span>
                @enderror
            </div>

            {{-- Campo condicional de contraseña --}}
            <div id="passwordDiv" 
                 class="form-group conditional-field"
                 aria-live="polite"
                 hidden>
                <label for="rolPassword">
                    Tu contraseña (para confirmar)
                    <span class="required" aria-hidden="true">*</span>
                    <span class="sr-only">(obligatorio cuando el rol es Administrador)</span>
                </label>
                <input type="password" 
                       id="rolPassword"
                       name="rol_password"
                       ...
                       class="@error('rol_password') input-error @enderror">
                <span id="pwd-hint" class="hint">Ingrese su contraseña actual para confirmar la asignación de rol administrador</span>
                @error('rol_password')
                    <span class="error-message" role="alert">{{ $message }}</span>
                @enderror
            </div>
